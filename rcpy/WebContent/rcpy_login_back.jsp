					...
					<div class="span4">
						<form class="form-horizontal" method="post" action="login_login.do" >
							<div class="control-group">
								...
								<div class="controls">
									<input id="login_inputId" name="userid" type="number" value="${user.userid }" onkeyup="value=value.replace(/[^\d]/g,'')"/>
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								<div class="controls">
									 ...
									 <button type="submit" id="login_btn" name="login_submit" class="btn">登陆</button>
								</div>
							</div>
						</form>
					</div>
