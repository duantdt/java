...
<table>
    <tr items="${page.currentPage}">
        ...
        <form method="GET" action="${pageContext.request.contextPath}/review.do?page2=${page.prefPage}">
    ...
    <table>
        <tr>
            <td>跳转到第:<input type="text" name="page1" size="5"/>页</td>
